...
public class Jouer extends AppCompatActivity {
    ...
    private void checkEnd(){
        ...
        if (iv_1.getVisibility()== View.INVISIBLE &&
            ...
            AlertDialog.Builder AlertdialogBuild= new AlertDialog.Builder(Jouer.this);
    ...
    private void frontOfCardRessource() {
        image101= R.drawable.fil;
        image102=R.drawable.lapin;
        image103=R.drawable.sardouk;
        image104= R.drawable.lion;
        image105=R.drawable.girafe;
        image106=R.drawable.gzel;

        image201= R.drawable.fil;
        image202=R.drawable.lapin;
        image203=R.drawable.sardouk;
        image204= R.drawable.lion;
        image205=R.drawable.girafe;
        image206=R.drawable.gzel;
