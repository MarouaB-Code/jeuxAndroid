...
public class Niveau2 extends AppCompatActivity {
    ...
    private void checkEnd(){
        ...
        if (iv_1.getVisibility()== View.INVISIBLE &&
            ...
            AlertDialog.Builder AlertdialogBuild= new AlertDialog.Builder(Niveau2.this);
            ...
            AlertdialogBuild.setPositiveButton("REJOUER", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent= new Intent(getApplicationContext(), Niveau2.class);
                    ...
                    .setNegativeButton("SUIVANT", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void frontOfCardRessource() {
        image101= R.drawable.tache_bleu;
        image102=R.drawable.tache_orange;
        image103=R.drawable.tache_rose;
        image104= R.drawable.tache_violet;
        image105=R.drawable.tache_jaune;
        image106=R.drawable.tache_vert;

        image201= R.drawable.tache_bleu;
        image202=R.drawable.tache_orange;
        image203=R.drawable.tache_rose;
        image204= R.drawable.tache_violet;
        image205=R.drawable.tache_jaune;
        image206=R.drawable.tache_vert;
